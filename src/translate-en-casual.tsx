...
interface Preferences {
  ...
  translateEnCasualModel: string;
}

export default async function TranslateEnCasualCommand() {
  ...
  try {
    ...
    if (response) {
      ...
      showToast(
        Toast.Style.Success,
        "Translated to casual English and copied to clipboard",
      );
    } else {
